...
namespace HuanLuyen
{
    public class modHuanLuyen
    {
        ...
        internal static int EditNodesCount;
        ...
        public static string myOLon99File = "..\\Data\\OLon99.txt";
        public static string myOPhu55File = "..\\Data\\OPhu55.txt";
                    ...
                    if (xmlNodeType == XmlNodeType.Element)
                    {
                        ...
                        if (name == "DEFAS" && rr.AttributeCount > 0)
                        {
                            while (rr.MoveToNextAttribute())
                            {
                                ...
                                {
                                    modHuanLuyen.defaPathColor = Color.FromArgb(int.Parse(rr.Value));
                                }
                                else if (name2 == "defaPathWidth")
                                {
                                    modHuanLuyen.defaPathWidth = int.Parse(rr.Value);
                                }
                                else if (name2 == "defaTopDichColor")
                                {
                                    modHuanLuyen.defaTopDichColor = Color.FromArgb(int.Parse(rr.Value));
                                }
                                else if (name2 == "defaTopTaColor")
                                {
                                    modHuanLuyen.defaTopTaColor = Color.FromArgb(int.Parse(rr.Value));
                                }
                                else if (name2 == "defaTopQuocTeColor")
                                {
                                    modHuanLuyen.defaTopQuocTeColor = Color.FromArgb(int.Parse(rr.Value));
                                }
                                else if (name2 == "defaTopQuaCanhColor")
                                {
                                    modHuanLuyen.defaTopQuaCanhColor = Color.FromArgb(int.Parse(rr.Value));
                                }
                                else if (name2 == "defaKhongVucColor")
                                {
                                    modHuanLuyen.defaKhongVucColor = Color.FromArgb(int.Parse(rr.Value));
                                }
                                else if (name2 == "defaRadaHLPenC")
                                {
                                    modHuanLuyen.defaRadaHLPenC = Color.FromArgb(int.Parse(rr.Value));
                                }
                                else if (name2 == "defaRadaHLPenW")
                                {
                                    modHuanLuyen.defaRadaHLPenW = int.Parse(rr.Value);
                                }
                                else if (name2 == "defaRadaDDPenC")
                                {
                                    modHuanLuyen.defaRadaDDPenC = Color.FromArgb(int.Parse(rr.Value));
                                }
                                else if (name2 == "defaRadaDDPenW")
                                {
                                    modHuanLuyen.defaRadaDDPenW = int.Parse(rr.Value);
                                }
                                else if (name2 == "defaPVRadius")
                                {
                                    modHuanLuyen.defaPVRadius = int.Parse(rr.Value);
                                }
                                else if (name2 == "defaPVPenC")
                                {
                                    modHuanLuyen.defaPVPenC = Color.FromArgb(int.Parse(rr.Value));
                                }
                                else if (name2 == "defaPVVongStep")
                                {
                                    modHuanLuyen.defaPVVongStep = int.Parse(rr.Value);
                                }
                                else if (name2 == "defaPVVongDam")
                                {
                                    modHuanLuyen.defaPVVongDam = int.Parse(rr.Value);
                                }
                                else if (name2 == "defaPVTiaStep")
                                {
                                    modHuanLuyen.defaPVTiaStep = int.Parse(rr.Value);
                                }
                                else if (name2 == "defaPVTiaDam")
                                {
                                    modHuanLuyen.defaPVTiaDam = int.Parse(rr.Value);
                                }
                            }
                        }
                    }
                        ...
                        if (xmlNodeType == XmlNodeType.Element)
                        {
                            ...
                            if (name == "PARA" && rr.AttributeCount > 0)
                            {
                                while (rr.MoveToNextAttribute())
                                {
                                    ...
                                    else if (name2 == "myOLon99File")
                                    {
                                        modHuanLuyen.myOLon99File = rr.Value;
                                    }
                                    else if (name2 == "myOPhu55File")
                                    {
                                        modHuanLuyen.myOPhu55File = rr.Value;
                                    }
