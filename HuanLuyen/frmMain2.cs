...
private ListenerProcess _ListenerProcess1;
...
[AccessedThroughProperty("myBanDoNen")]
...
if (MyProject.Computer.FileSystem.FileExists(modHuanLuyen.myDefaFile))
{
modHuanLuyen.LoadDefa(modHuanLuyen.myDefaFile);
}
if (MyProject.Computer.FileSystem.FileExists(modHuanLuyen.myGocPvClFile))
{
...
{
if (Operators.CompareString(this.myTblName, "tblAirport", false) == 0)
{
this.m_DrawingAirports = CAirports.GetList(this.myTblName);
}
else if (Operators.CompareString(this.myTblName, "tblDiaTieu", false) == 0)
{
this.m_DrawingDiaTieus = CAirports.GetList(this.myTblName);
}
else if (Operators.CompareString(this.myTblName, "tblTramQS", false) == 0)
{
...
{
if (this.m_SeleRada != null && Interaction.MsgBox("Vẽ vùng Khuất mới cho Rada " + this.m_SeleRada.Ten + "?", MsgBoxStyle.YesNo, null) == MsgBoxResult.Yes)
{
...
{
if (this.lstKhuat.SelectedItem != null && Interaction.MsgBox("Vẽ lại vùng Khuất này?", MsgBoxStyle.YesNo, null) == MsgBoxResult.Yes)
{
this.grdRadas.Enabled = false;
